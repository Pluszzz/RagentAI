...
### 1. 核心接口（`channel` 包）
```
bootstrap/src/main/java/com/pluszzz/ai/ragent/rag/core/retrieve/channel/
...
```
bootstrap/src/main/java/com/pluszzz/ai/ragent/rag/core/retrieve/channel/impl/
...
```
bootstrap/src/main/java/com/pluszzz/ai/ragent/rag/core/retrieve/postprocessor/
...
### 4. 多通道检索引擎
```
bootstrap/src/main/java/com/pluszzz/ai/ragent/rag/core/retrieve/
