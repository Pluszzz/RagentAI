...
public class BaiLianChatClient implements ChatClient {
    ...
    private JsonArray buildMessages(ChatRequest request) {
        ...
        List<com.pluszzz.ai.ragent.framework.convention.ChatMessage> messages = request.getMessages();
        if (CollUtil.isNotEmpty(messages)) {
            for (com.pluszzz.ai.ragent.framework.convention.ChatMessage m : messages) {
    ...
    private String toOpenAiRole(com.pluszzz.ai.ragent.framework.convention.ChatMessage.Role role) {
        return switch (role) {
            case SYSTEM -> "system";
            case USER -> "user";
