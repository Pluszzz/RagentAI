...
import com.pluszzz.ai.ragent.knowledge.controller.request.KnowledgeBaseCreateRequest;
import com.pluszzz.ai.ragent.knowledge.controller.request.KnowledgeBasePageRequest;
import com.pluszzz.ai.ragent.knowledge.controller.request.KnowledgeBaseUpdateRequest;
import com.pluszzz.ai.ragent.knowledge.controller.vo.KnowledgeBaseVO;
...
import com.pluszzz.ai.ragent.knowledge.rag.core.vector.VectorSpaceSpec;
import com.pluszzz.ai.ragent.knowledge.rag.core.vector.VectorStoreAdmin;
import com.pluszzz.ai.ragent.knowledge.service.KnowledgeBaseService;
...
public class KnowledgeBaseServiceImpl implements KnowledgeBaseService {
    ...
    public String create(KnowledgeBaseCreateRequest requestParam) {
        ...
        // Milvus 只允许 [a-z0-9_]；S3 不允许 _，只允许 [a-z0-9-]
        String collectionName = requestParam.getCollectionName()
                .toLowerCase().replaceAll("[^a-z0-9_]", "");
        String bucketName = collectionName.replace('_', '-');
