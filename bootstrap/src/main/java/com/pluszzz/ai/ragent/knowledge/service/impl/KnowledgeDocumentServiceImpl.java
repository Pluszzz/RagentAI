 ...
 */
package com.pluszzz.ai.ragent.knowledge.service.impl;
...
import com.pluszzz.ai.ragent.infra.embedding.EmbeddingService;
import com.pluszzz.ai.ragent.knowledge.controller.request.KnowledgeChunkCreateRequest;
import com.pluszzz.ai.ragent.knowledge.controller.request.KnowledgeDocumentUpdateRequest;
import com.pluszzz.ai.ragent.knowledge.controller.request.KnowledgeDocumentUploadRequest;
import com.pluszzz.ai.ragent.knowledge.controller.vo.KnowledgeChunkVO;
import com.pluszzz.ai.ragent.knowledge.controller.vo.KnowledgeDocumentVO;
import com.pluszzz.ai.ragent.knowledge.controller.vo.KnowledgeDocumentChunkLogVO;
import com.pluszzz.ai.ragent.knowledge.controller.vo.KnowledgeDocumentSearchVO;
import com.pluszzz.ai.ragent.core.chunk.ChunkingMode;
import com.pluszzz.ai.ragent.core.chunk.ChunkingOptions;
import com.pluszzz.ai.ragent.core.chunk.ChunkingStrategyFactory;
import com.pluszzz.ai.ragent.core.chunk.VectorChunk;
import com.pluszzz.ai.ragent.core.chunk.ChunkingStrategy;
import com.pluszzz.ai.ragent.knowledge.dao.entity.KnowledgeBaseDO;
import com.pluszzz.ai.ragent.knowledge.dao.entity.KnowledgeDocumentDO;
import com.pluszzz.ai.ragent.knowledge.dao.entity.KnowledgeDocumentChunkLogDO;
import com.pluszzz.ai.ragent.knowledge.dao.mapper.KnowledgeBaseMapper;
import com.pluszzz.ai.ragent.knowledge.dao.mapper.KnowledgeDocumentMapper;
import com.pluszzz.ai.ragent.knowledge.dao.mapper.KnowledgeDocumentChunkLogMapper;
import com.pluszzz.ai.ragent.knowledge.rag.dto.StoredFileDTO;
import com.pluszzz.ai.ragent.knowledge.enums.DocumentStatus;
import com.pluszzz.ai.ragent.knowledge.enums.ProcessMode;
import com.pluszzz.ai.ragent.knowledge.enums.SourceType;
import com.pluszzz.ai.ragent.framework.context.UserContext;
...
import com.pluszzz.ai.ragent.knowledge.rag.core.vector.VectorStoreService;
import com.pluszzz.ai.ragent.knowledge.rag.core.vector.VectorSpaceId;
import com.pluszzz.ai.ragent.knowledge.rag.service.FileStorageService;
import com.pluszzz.ai.ragent.knowledge.service.KnowledgeChunkService;
import com.pluszzz.ai.ragent.knowledge.service.KnowledgeDocumentService;
import com.pluszzz.ai.ragent.knowledge.service.KnowledgeDocumentScheduleService;
import com.pluszzz.ai.ragent.knowledge.schedule.CronScheduleHelper;
import com.pluszzz.ai.ragent.ingestion.util.HttpClientHelper;
import com.pluszzz.ai.ragent.ingestion.service.IngestionPipelineService;
import com.pluszzz.ai.ragent.ingestion.engine.IngestionEngine;
import com.pluszzz.ai.ragent.ingestion.dao.entity.IngestionPipelineDO;
import com.pluszzz.ai.ragent.ingestion.dao.mapper.IngestionPipelineMapper;
import com.pluszzz.ai.ragent.ingestion.domain.context.IngestionContext;
import com.pluszzz.ai.ragent.ingestion.domain.pipeline.PipelineDefinition;
...
public class KnowledgeDocumentServiceImpl implements KnowledgeDocumentService {
    ...
    public KnowledgeDocumentVO upload(String kbId, KnowledgeDocumentUploadRequest request, MultipartFile file) {
        ...
        // S3 bucket 名和 Milvus collection 名规则不同，bucket 需将 _ 转为 -
